...
This is a modified version of the original Combat Enhancer 5E Classic extension for Fantasy Grounds, updated for the latesst version of Fantasy Grounds.
As part of this update, I have merged in Token Helper, so that extension is no longer required.
